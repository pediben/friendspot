...
const NATIVE_EVENTS = ['peerConnectionSignalingStateChanged', 'peerConnectionStateChanged', 'peerConnectionOnRenegotiationNeeded', 'peerConnectionIceConnectionChanged', 'peerConnectionIceGatheringChanged', 'peerConnectionGotICECandidate', 'peerConnectionDidOpenDataChannel', 'peerConnectionOnRemoveTrack', 'peerConnectionOnTrack', 'dataChannelStateChanged', 'dataChannelReceiveMessage', 'dataChannelDidChangeBufferedAmount', 'mediaStreamTrackMuteChanged', 'mediaStreamTrackEnded', 'frameCryptionStateChanged', 'audioDeviceModuleEngineCreated', 'audioDeviceModuleEngineWillEnable', 'audioDeviceModuleEngineWillStart', 'audioDeviceModuleEngineDidStop', 'audioDeviceModuleEngineDidDisable', 'audioDeviceModuleEngineWillRelease', 'audioDeviceModuleSpeechActivity', 'audioDeviceModuleDevicesUpdated'];
