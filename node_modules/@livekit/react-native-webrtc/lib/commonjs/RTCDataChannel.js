...
class RTCDataChannel extends _eventTargetShim.EventTarget {
  ...
  get onbufferedamountlow() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'bufferedamountlow');
  }
  set onbufferedamountlow(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'bufferedamountlow', value);
  }
  get onclose() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'close');
  }
  set onclose(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'close', value);
  }
  get onclosing() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'closing');
  }
  set onclosing(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'closing', value);
  }
  get onerror() {
  ...
  get onmessage() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'message');
  }
  set onmessage(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'message', value);
  }
  get onopen() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'open');
  }
  set onopen(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'open', value);
  }
  get bufferedAmount() {
