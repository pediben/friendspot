 ...
 */
class RTCFrameCryptorStateEvent extends _eventTargetShim.Event {
  /** @eventProperty */
...
class RTCFrameCryptor extends _eventTargetShim.EventTarget {
  ...
  get onframecryptorstatechanged() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'framecryptorstatechanged');
  }
  set onframecryptorstatechanged(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'framecryptorstatechanged', value);
  }
}
