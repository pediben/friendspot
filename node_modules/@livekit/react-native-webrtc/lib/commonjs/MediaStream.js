...
class MediaStream extends _eventTargetShim.EventTarget {
  ...
  get onaddtrack() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'addtrack');
  }
  set onaddtrack(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'addtrack', value);
  }
  get onremovetrack() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'removetrack');
  }
  set onremovetrack(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'removetrack', value);
  }
  get id() {
    return this._id;
  }
