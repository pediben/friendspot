 ...
 */
export function setupIOSAudioManagement(preferSpeakerOutput = true, onConfigureNativeAudio) {
  if (Platform.OS !== 'ios') {
    return () => {};
  }
  const setupToken = {};
