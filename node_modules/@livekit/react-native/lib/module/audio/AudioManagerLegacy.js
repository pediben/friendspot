...
import { setupIOSAudioManagement } from './AudioManager';
 ...
 */
export function useIOSAudioManagement(_room, preferSpeakerOutput = true, onConfigureNativeAudio) {
  ...
  useEffect(() => {
    const wrapped = state => {
      ...
      return cb ? cb(trackState, state.preferSpeakerOutput) : getDefaultAppleAudioConfigurationForMode(trackState, state.preferSpeakerOutput);
    };
...
function engineStateToTrackState(state) {
...
//# sourceMappingURL=AudioManagerLegacy.js.map