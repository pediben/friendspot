...
import { RTCView, type RTCIOSPIPOptions } from '@livekit/react-native-webrtc';
 ...
 * @public
 */
export declare const VideoTrack: ForwardRefExoticComponent<VideoTrackProps & RefAttributes<RTCViewInstance>>;
export {};
