        ...
        if (dbErr || !data) {
          ...
          if (membership?.role === "admin" || membership?.role === "owner") {
            ...
            try {
              ...
              // upsert instead of insert to handle the case where the row
              // already exists (e.g. self-heal runs twice due to React
              // StrictMode double-mount or a stale in-memory key miss).
